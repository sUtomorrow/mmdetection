...
def bbox_mapping(bboxes, img_shape, scale_factor, flip, flip_direction='horizontal'):
    ...
    if flip:
        new_bboxes = bbox_flip(new_bboxes, img_shape, flip_direction=flip_direction)
    return new_bboxes


def bbox_mapping_back(bboxes, img_shape, scale_factor, flip, flip_direction='horizontal'):
    """Map bboxes from testing scale to original image scale"""
    new_bboxes = bbox_flip(bboxes, img_shape, flip_direction=flip_direction) if flip else bboxes
