...
def bbox_flip(bboxes, img_shape, flip_type='horizontal'):
    ...
    """
    assert flip_type in ['vertical', 'horizontal']
...
def bbox_mapping(bboxes, img_shape, scale_factor, flip, flip_type='horizontal'):
    """Map bboxes from the original image scale to testing scale"""
    new_bboxes = bboxes * scale_factor
    if flip:
        new_bboxes = bbox_flip(new_bboxes, img_shape, flip_type=flip_type)
    return new_bboxes


def bbox_mapping_back(bboxes, img_shape, scale_factor, flip, flip_type='horizontal'):
    """Map bboxes from testing scale to original image scale"""
    new_bboxes = bbox_flip(bboxes, img_shape, flip_type=flip_type) if flip else bboxes
