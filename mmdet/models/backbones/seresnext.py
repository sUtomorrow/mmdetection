...
class SEResNeXt(ResNet):
    ...
    @property
    def norm1(self):
        return getattr(self, self.layer0.norm1_name)

    @property
    def conv1(self):
        return getattr(self, self.layer0.conv1)

    @property
    def relu(self):
        return getattr(self, self.layer0.relu)

    @property
    def maxpool(self):
        return getattr(self, self.layer0.maxpool)
